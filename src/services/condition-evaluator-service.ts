...
export class ConditionEvaluatorService {
   ...
   */
  private operatorFunctions: Record<
    string,
    (a: any, b: any, field?: string) => boolean | Promise<boolean>
  > = {
    ...
    exists: (a: any, _b: unknown) => a !== undefined && a !== null,
    // eslint-disable-next-line @typescript-eslint/no-unused-vars
    not_exists: (a: any, _b: unknown) => a === undefined || a === null,
